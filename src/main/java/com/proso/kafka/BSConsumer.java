...
public class BSConsumer {
    ...
    public void consume(){
        ...
        topicCountMap.put("bslog", new Integer(5));
        ...
        List<KafkaStream<String, String>> kafkaStreams = map.get("bslog");
            ...
            executor.submit(new Runnable() {
                public void run() {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        System.out.println("bsmsg:"+msg);
                        FileWR.write("C:\\log\\bslog.txt",msg);
                    }
                }
            });
        }
