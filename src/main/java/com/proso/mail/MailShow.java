...
public class MailShow {
    ...
    public MailShow(MimeMessage mimeMessage) {
    ...
    public MailShow(String userName, String password) {
        this.userName = userName;
        this.password = password;
    }


    public ArrayList<MailShow> getEmailList() throws Exception {
        String protocol = "pop3";
        boolean isSSL = true;
        int port = 995;
        String host = "pop-mail.outlook.com";
//        String username = "hlllly@outlook.com";
//        String password = "QWE@qwe123";
        ...
        ArrayList<MailShow> mailList=new ArrayList<MailShow>();
        for(Message msg:message){ mailList.add(new MailShow((MimeMessage) msg)); }
        return mailList;
//     for (int i = 0; i < message.length; i++) {
//            re = new MailShow((MimeMessage) message[i]);
//            re.getSubject();
//            re.getSentDate();
//            re.getReplySign();
//            re.isNew();
...
//        MailShow show=new MailShow("hlllly@outlook.com", "QWE@qwe123");
//        ArrayList<MailShow> list=new ArrayList<MailShow>();
//        list=show.getEmailList();
