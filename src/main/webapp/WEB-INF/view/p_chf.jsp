...
<head>
    ...
    <script type="text/javascript">
        function forword() {
            window.location.href="${pageContext.request.contextPath}/inChat/toP_CHF/${email}";
        }
...
<script>
    ...
    function deleteHail(hailEmail) {
        var ajax=$.ajax({url:"${pageContext.request.contextPath}/inChat/deleteHailRelation?hailEmail="+hailEmail+"&selfEmail=${email}",async:false});
        alert("删除成功!");
