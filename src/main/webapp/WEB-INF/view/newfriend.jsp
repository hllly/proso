        ...
        <div class="row about">
            <div class="col-md-12" >
                ...
                <div class="classes" style=" height:500px;overflow:scroll;">
                    ...
                    <%--<c:forEach items="${friend}" var="item" >--%>
                        <div class="cardio_list">
                            <div class="cardio_sublist">
                                <ul class="cardio">
                                    <li><i class="clock"> </i><span id="${friend.getP_email()}">${friend.getP_email()}</span></li>
                                </ul>
                                <div class="social-media">
                                    <ul>
                                        <li> <span class="simptip-position-bottom simptip-movable" data-tooltip="添加好友">
                                            ...
                                            <a href="#"  id="test" target="_self"><img src="/img/添加好友.png" style="height:20px;width:20px;" onclick='addHail("${friend.getP_email()}")'> </a></span></li>
                            ...
                            <p id="emailp" style="display: none;">${friend.getP_email()}</p>
                        </div>
                    <%--</c:forEach>--%>
...
<script>
    function addHail(hailEmail) {
        var ajax=$.ajax({url:"${pageContext.request.contextPath}/inChat/addHailRelation?hailEmail="+hailEmail+"&selfEmail=${email}",async:false});
        alert("添加成功!");
