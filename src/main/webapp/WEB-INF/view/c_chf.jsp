...
<head>
    ...
    <script type="text/javascript">
        function forword() {
            window.location.href="${pageContext.request.contextPath}/c_user/tochf?email=${email}";
        }
    ...
    <div class="container">
        ...
        <div class="h_menu4"><!-- start h_menu4 -->
            ...
            <ul class="nav">
                ...
                <li><a href="${pageContext.request.contextPath}/c_user/tochf?email="+${email}>好友</a></li>
                ...
                <li><a href="${pageContext.request.contextPath}/c_user/toC_record?="+${email}>企业档案</a></li>
        ...
        <div class="row about">
            <div class="col-md-8" >
                ...
                <div class="classes" style=" height:500px;overflow:scroll;">
                    ...
                    <c:forEach items="${hailEmailList}" var="item" >
                        <div class="cardio_list">
                            <div class="cardio_sublist">
                                <ul class="cardio">
                                    <li><i class="clock"> </i><span id="${item.hailEmail}">${item.hailEmail}</span></li>
                                </ul>
                                <div class="social-media">
                                    <ul>
                                        <li> <span class="simptip-position-bottom simptip-movable" data-tooltip="文字聊天">
                                            <a href="${pageContext.request.contextPath}/msg/login?to=${item.hailEmail}&from=${email}"  id="test" target="_self" onclick="toSendMessage('${item.hailEmail}')"><img src="/img/2.png" style="height:20px;width:20px;"> </a></span></li>
                                        <li><span class="simptip-position-bottom simptip-movable" data-tooltip="视频通话"><a href="#" target="_self"><img src="/img/1.png" style="height:20px;width:25px;" onclick="getInformation()"></a> </span></li>
                                        <li><span class="simptip-position-bottom simptip-movable" data-tooltip="删除好友"><a href="#" target="_self"><img src="/img/删除好友.png" style="height:20px;width:25px;" onclick="deleteHail(${item.hailEmail})"></a> </span></li>
                        ...
                        <p id="emailp" style="display: none;">${item.hailEmail}</p>
                    </c:forEach>
            ...
            <div class="col-md-4">
                <h3 class="m_4">好友推荐</h3>
                <div class="members">
                    <p><br/></p>
                    <h4 class="m_3">查看CUCU为您推荐的好友</h4>
                    <p>CUCU根据您的职业档案和基本信息， <br>为您推荐的这些好友可能是您认识的同事或同行，<br> 或者是您感兴趣的朋友.</p>
                    <div class="btn1">
                        <a href="${pageContext.request.contextPath}/p_user/lookAdvice?email=${email}">去看看</a>
                    </div>
                    <p><br/><br/></p>
                    <h4 class="m_3">通过Email找人</h4>
                    <form action="/p_user/toNewFriend" method="post">
                        <input type="text" value="" name="searchEmail" id="serachEmail">
                        <div class="btn1">
                            <a href="" id="serach">查找此人</a>
                            <input type="text" value="${email}" name="email" style="display: none;">
                            <input type="submit" style="margin-top:-10px;margin-left: -50px;opacity: 0.0;"/>
                        </div>
                    </form>
                    <p><br/></p>
...
<p id="pemail" hidden>${email}</p>

</div>

<script>

    function deleteHail(hailEmail) {
        $selfEmail=$("#pemail").text();
        var ajax=$.ajax({url:"${pageContext.request.contextPath}/inChat/deleteHailRelation?hailEmail="+hailEmail+"&selfEmail="+$selfEmail,async:false});
        alert("删除成功!");
    ...
    function getEmail() {
        var val = $("#serachEmail").val(); //获取
        var value = $("input[name='searchEmail'][type='text']:checked").val();//获得选中项的值
        var result="${pageContext.request.contextPath}/p_user/toNewFriend?email1="+val+"&email2="+${email};
